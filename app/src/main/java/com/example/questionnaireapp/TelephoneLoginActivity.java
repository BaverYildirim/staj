...
public class TelephoneLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                firebaseAuth.signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            //Kullanıcı sisteme girmişsse tekrar tekrar sisteme girmesini önlemek
                            databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                    if(snapshot.exists()){
                                        ...
                                        hashMap.put("Name", "Baver");
                                        hashMap.put("Surname", "Yıldırım");
                                        hashMap.put("Photo", "");
                                        hashMap.put("Status", "selamlar");
        ...
        //confirmationButonId on Click Listener
